 ...
 * on 2015-06-23 at 13:15:35 UTC 
 * Modify at your own risk.
 */

package com.krypto.backend.jokeApi;
...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://endpoint-backend.appspot.com/_ah/api/";
   ...
   *
   * @param content the {@link com.krypto.backend.jokeApi.model.Joke}
   * @return the request
   */
  public InsertJoke insertJoke(com.krypto.backend.jokeApi.model.Joke content) throws java.io.IOException {
    InsertJoke result = new InsertJoke(content);
    initialize(result);
    return result;
  }

  public class InsertJoke extends JokeApiRequest<com.krypto.backend.jokeApi.model.Joke> {
     ...
     * @since 1.13
     */
    protected InsertJoke(com.krypto.backend.jokeApi.model.Joke content) {
      super(JokeApi.this, "POST", REST_PATH, content, com.krypto.backend.jokeApi.model.Joke.class);
    }
